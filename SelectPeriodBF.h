...
#ifndef SelectPeriodBFH
#define SelectPeriodBFH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TSelectPeriodBrowseForm : public TForm
{
...
public:		// User declarations
        __fastcall TSelectPeriodBrowseForm(TComponent* Owner, int date1, int date2);
